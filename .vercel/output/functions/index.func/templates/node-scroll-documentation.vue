...
<!-- 
  ...
  - modified from documentation w/ scroll spy
-->
  ...
  <div class="Node-Documentation">
    <Documentation>
      <template #sidebar>
        ...
        >
          <div class="_sidebar-content --max-height-90 ">
            ...
            <div 
              v-scroll-spy-active="{class: '--scrollspy-active', selector: '._sidebar-item'}" 
              v-scroll-spy-link="{selector: 'a._sidebar-item'}"
              :class="pathMatch(source.fields['Node:AbsolutePath']) && !source.fields['Data:isChecked'] ? '--active' : ''" 
              class="_sidebar-content-group scrollspy"
            >
              ...
              <nuxt-link
                ...
                class="_sidebar-item --active-disabled" 
              >
              ...
              <div v-if="pathMatch(source.fields['Node:AbsolutePath'])" :class="!source.fields['Data:isChecked'] ? '_sidebar-submenu' : ''" > 
                ...
                >
                  ...
                  <nuxt-link 
                    :to="`${source.fields['Node:Nav-Links'][index]}`" class="_sidebar-item _sidebar-subitem --active-disabled" 
                  >
                    {{ item }}
                  </nuxt-link>
                </div>
      ...
      <template v-slot:[slotName(node)]>
        ...
        <!-- <div class="header" v-html="$md.render(node.fields['Markdown'] || '')" /> -->
        <NodeRenderer :header="node.fields['Markdown']" :nodes="contents" />
        <!-- </div> -->
      </template>
