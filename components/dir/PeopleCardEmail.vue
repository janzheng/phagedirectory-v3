            ...
            <div class="People-name People-header-block ">
              ...
              <div class="People-name-social">
                ...
                <div v-if="hasSocial" class="Dir-social Dir-title">
                  ...
                  <a v-if="person.fields['Social:ORCID']" :href="`${person.fields['Social:ORCID']}`" class="Dir-icon --url"><img alt="ORCID Logo" width="23" style="position: relative; bottom: -3px; margin-right: 4px;" src="https://gallery.mailchimp.com/a95319e0a6f57b754b11012a8/images/6c0c221a-b8da-4357-8036-f35f85d39c79.png"></a>
                  <a v-if="person.fields['Social:Publons']" :href="`${person.fields['Social:Publons']}`" class="Dir-icon --url"><img alt="Publons Logo" width="23" style="position: relative; bottom: -3px; margin-right: 4px;" src="https://gallery.mailchimp.com/a95319e0a6f57b754b11012a8/images/7e230d1b-4bc0-46c1-8c17-24e30ab03be9.png"></a>
                  ...
                  <a v-if="person.fields['Social:Github']" :href="`${person.fields['Social:Github']}`" class="Dir-icon --url"><img alt="Github Logo" width="23" style="position: relative; bottom: -3px; margin-right: 4px;" src="https://gallery.mailchimp.com/a95319e0a6f57b754b11012a8/images/70af7d76-2104-4326-8e48-f9a915a42557.png"></a>
                </div>
              </div>
