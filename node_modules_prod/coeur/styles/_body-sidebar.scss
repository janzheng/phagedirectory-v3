...
/* 
  ...
  - a lot of sidebar was written for the original middleman docs, which had a fixed left sidebar
    it's being rewritten to be a whole lot more flexible 


 */


$sidebar-size: $font-size !default;
...
$sidebar-border: $border-line solid $color-ui !default;

$sidebar-submenu-border: $border-line solid $color-main !default;
...
._sidebar {
  ...
  &.\--height-max { // full left-side scrollable nav, for docs usually
    min-width: 170px; // arbitrarily hard coded
  ...
  a {
    ...
    margin-bottom: math.div($size-base,4);
  ...
  /* CLEAN THIS UP LATER — separate it from base side menu */
  ...
  //     // newer right-aligned arrows (like Spotify)
  //     i, svg {
...
// // this is attached to the container wrapping the sidebar
