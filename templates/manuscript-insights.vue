...
<!-- 
  ...
  Insights template, built on Capsid template

 -->

<template>
  <div class="Template-Manuscript-Insights _margin-top-2 _margin-bottom-2 _grid-3-1-sm _grid-gap-small _center-margin _container _padding ">
